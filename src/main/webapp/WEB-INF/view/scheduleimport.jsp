...
<div id="pagewidth">
    ...
    <div id="wrapper" class="clearfix">
        ...
        <form id="importform" method="get" action="<c:url value="/scheduleimportback"/>">
            ID task <input type="text" name="idtask"><br>
            Start date<input name="datestartimport" type="text" onfocus="(this.type='date')" onfocusout="(this.type='text')" style="width: 100px; height: 25px;">
            <br>
            End Date<input name="dateendimport" type="text" onfocus="(this.type='date')" onfocusout="(this.type='text')" style="width: 100px; height: 25px;">
            ...
            <a href="<c:url value="/resources/testcsv.txt"/>">test files export</a>
