...
<div id="pagewidth">
    ...
    <div id="wrapper" class="clearfix">
        ...
        <div id="maincol" style="width: 100%; min-width: 1040px; min-height:600px; margin-left:240px;background: url(<c:url value="/resources/images/infobackground.png"/>);">
            <form id="adduserform" method="get" action="<c:url value="/adduserback"/>">
                Username <input type="text" name="username"><br>
                Password <input type="text" name="password"><br>
                Databases <input type="text" name="databases"><br>
                Keywords(e.g. word 1 or word2 or word3) <input type="text" name="keywords"><br>
                Competitors <input type="text" name="competitors"><br>
                E-mail <input type="text" name="email"><br>
                Datestart('yyyy-MM-dd') <input type="text" name="datestart"><br>
                Dateend('yyyy-MM-dd') <input type="text" name="dateend"><br>
                Own Name <input type="text" name="ownname"><br>
                Plan <input type="text" name="plan"><br>
                Resources <input type="text" name="resources"><br>
                Alerting(true/false) <input type="text" name="alerting"><br>
                Frequency Alerting <input type="text" name="freq"><br>
